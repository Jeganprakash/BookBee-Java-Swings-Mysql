...
public class model {
    ...
    public model() {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bookbee", "root", "Jeganprakash@13");
    ...
    public int[] getSuggestion() {
        int[] res = new int[6];
        try {
            PreparedStatement ps = con.prepareStatement("select * FROM books where category=? ORDER BY rating DESC");
