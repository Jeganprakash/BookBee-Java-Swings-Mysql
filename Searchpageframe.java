...
class MysqlCon {
    String createconnection(String category, String sql, int type, JFrame f) {
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bookbee", "root", "password");
            int id[] = new int[100];
            int i = 0;
...
public class Searchpageframe {
    ...
    public static void searchpagecall(int uid) {
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection c = DriverManager.getConnection("jdbc:mysql://localhost:3306/bookbee", "root", "password");
        ...
        JButton entertainment = new JButton("Fantasy");
        ...
        JButton history = new JButton("Programming");
        ...
        history.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String sql = "SELECT name,id FROM books WHERE category = ?";
                String name = makecon.createconnection(category, sql, type, searchframe);
            }
        });
        searchframe.add(history);

        JButton story = new JButton("Biographies");
        ...
        JButton knowledge = new JButton("Knowledge");
